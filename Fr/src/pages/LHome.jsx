...
import { fetchBooks, addBook, updateBook, deleteManyBooks } from '../services/api'; // Ensure these are correctly implemented
...
const LHome = () => {
     ...
     const handleFilterChange = (e) => setSelectedGenre(e.target.value);

     const handleSortChange = (e) => setSortOrder(e.target.value);

     const filteredBooks = books.filter((book) => {
          const hasTitle = typeof book.title === 'string';
          const hasGenre = typeof book.genre === 'string';

          return (
               hasTitle &&
               book.title.toLowerCase().includes(searchQuery.toLowerCase()) &&
               (selectedGenre === 'All' || (hasGenre && book.genre === selectedGenre))
          );
     });

     const sortedBooks = filteredBooks.sort((a, b) => {
          if (sortOrder === 'title' && typeof a.title === 'string' && typeof b.title === 'string') {
               return a.title.localeCompare(b.title);
          } else if (sortOrder === 'author' && typeof a.author === 'string' && typeof b.author === 'string') {
                    ...
                    <div className="container mx-auto">
                         ...
                         <div className="flex flex-col md:flex-row md:justify-between mb-6">
                              <div className="flex items-center space-x-4 mb-4 md:mb-0">
                                   ...
                                   >
                                        <option value="All" className='bg-white dark:bg-gray-900 text-black dark:text-white'>All Genres</option>
                                        <option value="Fiction" className='bg-white dark:bg-gray-900 text-black dark:text-white'>Fiction</option>
                                        <option value="Dystopian" className='bg-white dark:bg-gray-900 text-black dark:text-white'>Dystopian</option>
                                        <option value="Classic" className='bg-white dark:bg-gray-900 text-black dark:text-white'>Classic</option>
                                   ...
                                   >
                                        ...
                                        <option value="author" className='bg-white dark:bg-gray-900 text-black dark:text-white'>Sort by Author</option>
